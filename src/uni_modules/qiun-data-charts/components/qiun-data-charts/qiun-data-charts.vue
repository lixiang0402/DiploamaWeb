...
<template>
  <view class="chartsview">
    ...
    <!-- #ifdef APP-PLUS || H5 -->
    <block v-if="echarts">
      <view :style="{ background: background }" style="width: 100%;height: 100%;" :id="'EC' + echartsOpts.id" :prop="echartsOpts" :change:prop="rdcharts.ecinit" :resize="echartsResize" :change:resize="rdcharts.ecresize" v-show="showchart" />
    </block>
    <block v-else>
    ...
    <block v-if="type2d">
      <view v-if="ontouch">
        <canvas :id="cid" :style="{ width: cWidth + 'px', height: cHeight + 'px', background: background }" type="2d" :disable-scroll="disScroll" @tap="_tap" @touchstart="_touchStart" @touchmove="_touchMove" @touchend="_touchEnd" @error="_error" v-show="showchart" />
      </view>
      <view v-if="!ontouch">
        <canvas :id="cid" :style="{ width: cWidth + 'px', height: cHeight + 'px', background: background }" type="2d" :disable-scroll="disScroll" @tap="_tap" @error="_error" v-show="showchart" />
      </view>
    </block>
    <block v-if="!type2d">
      <view v-if="ontouch">
        <canvas :id="cid" :canvasId="cid" :style="{ width: cWidth + 'px', height: cHeight + 'px', background: background }" @tap="_tap" @touchstart="_touchStart" @touchmove="_touchMove" @touchend="_touchEnd" :disable-scroll="disScroll" @error="_error" v-if="showchart" />
      </view>
      <view v-if="!ontouch">
